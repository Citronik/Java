package sk.clovece.hraciadoska;
...
public class Stvorec {
    ...
    /**
     * (Štvorec) Zmeň dĺžku strany na hodnotu danú parametrom.Dĺžka strany musí byť nezáporné celé číslo.
     * @param dlzka 
     */
    ...
    public void posunNa(int posunNaY, int posunNaX) {
        this.zmaz();
        this.lavyHornyY = posunNaY;
        this.lavyHornyX = posunNaX;
        this.nakresli();
    }
}
